...
@ManagedBean
@RequestScoped
public class jlrFlow_Client_Payment  extends jlrFlow_ {
    ...
    private void payment(){
        model = getModel();
        Element       Mgmt = new Element("Client Mgmt",     "40em", "1em"),
                Seek = new Element("Client Search",         "10em", "2em"),
                Itinerary = new Element("Show Itinerary", "2em", "10em"),
        ...
        model.connect(createConnection(maintClient1.getEndPoints().get(0), Seek.getEndPoints().get(0), null));
