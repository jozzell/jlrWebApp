...
@ManagedBean
@RequestScoped
public class jlrFlow_Client_Booking   extends jlrFlow_ {
    private DefaultDiagramModel model;
    public DefaultDiagramModel genModel(){
        if (model == null) booking();
        return model;
    }
    private void booking(){
        ...
        Element       Mgmt = new Element("Client Mgmt",     "50em", "0em"),
                ...
                Itinerary = new Element("Client Itinerary",         "10em", "0em"),
                currBooking = new Element("Client Current Booking", "2em", "10em"),
